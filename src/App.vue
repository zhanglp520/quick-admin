...
const setColor = (setting: any) => {
  ...
  for (let i = 1; i < 10; i++) {
    ...
    el.style.setProperty(`--el-color-info-light-${i}`, colourBlend(infoColor, mixColor, i / 10))
    el.style.setProperty(`--el-color-info-dark-${i}`, colourBlend(infoColor, mixColor, i / 10))
    ...
    el.style.setProperty(`--el-color-danger-light-${i}`, colourBlend(dangerColor, mixColor, i / 10))
    el.style.setProperty(`--el-color-danger-dark-${i}`, colourBlend(dangerColor, mixColor, i / 10))
  }
  el.style.setProperty(`--el-color-default-dark-2`, colourBlend(defaultColor, mixColor, 0.2))
  el.style.setProperty(`--el-color-primary-dark-2`, colourBlend(primaryColor, mixColor, 0.2))
  el.style.setProperty(`--el-color-info-dark-2`, colourBlend(infoColor, mixColor, 0.2))
  el.style.setProperty(`--el-color-success-dark-2`, colourBlend(successColor, mixColor, 0.2))
  el.style.setProperty(`--el-color-warning-dark-2`, colourBlend(warningColor, mixColor, 0.2))
  el.style.setProperty(`--el-color-danger-dark-2`, colourBlend(dangerColor, mixColor, 0.2))
}
